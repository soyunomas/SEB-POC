...
func RunExamSession(ctx context.Context, cfg *config.SEBConfig, internalBEK string) error {
	...
	profileDir := filepath.Join(os.Getenv("APPDATA"), "seb-windows-profile")
	...
	userAgent := "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36 SafeExamBrowser/3.3.0"
	...
	log.Println("[INFO] Perfil persistente en %APPDATA%\\seb-windows-profile — instala plugins desde chrome://extensions")
